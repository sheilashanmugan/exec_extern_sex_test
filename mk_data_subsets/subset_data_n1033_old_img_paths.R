...
data14<- subset(data13, cope.path.2m0 != "NA")
data14<- subset(data13, varcope.path.2m0 != "NA")

data16 <- data14 #n=1033
#demean vars
...
write.csv(data16, file = "/data/jux/BBL/projects/exec_extern_sex/inputData/data_agg/nback_n1033_from1601_oldImgPaths_20180829.csv")
