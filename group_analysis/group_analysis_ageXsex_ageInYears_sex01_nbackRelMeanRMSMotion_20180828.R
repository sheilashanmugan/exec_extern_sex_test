...
lin.mod<-"~  ageInYears*sex01 + ageInYears + sex01 + nbackRelMeanRMSMotion"
int <- "ageInYearsXsex01"
###
...
#######################
file.copy("/data/jux/BBL/projects/exec_extern_sex/scripts/group_analysis_ageXsex_ageInYears_sex01_nbackRelMeanRMSMotion_20180828.R",resultsdir)
