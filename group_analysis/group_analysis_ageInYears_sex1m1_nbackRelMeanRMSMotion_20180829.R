...
lin.mod<-"~  ageInYears + sex1m1 + nbackRelMeanRMSMotion"
###
...
#######################
file.copy("/data/jux/BBL/projects/exec_extern_sex/scripts/group_analysis/group_analysis_ageInYears_sex1m1_nbackRelMeanRMSMotion_20180829.R",resultsdir)
