---
title: "Sex Differences in Clinical Data"
output:
...
```{r, echo=FALSE, message=FALSE}
ggplot(dataa,aes(x=ageInYears, fill=sex01)) + geom_histogram()+facet_grid(~sex01)
```

```{r include=FALSE}
yvar="externalizing_4factorv2"
data1 <- subset(dataa, select=c("scanid", yvar, "ageInYears", "sex01"))
data1["yvar"] <- data1[,2]
data1<- subset(data1, yvar != "NA")
```
