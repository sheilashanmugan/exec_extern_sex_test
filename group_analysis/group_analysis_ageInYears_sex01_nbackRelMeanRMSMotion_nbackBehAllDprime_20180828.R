...
###ALL COVARIATES
variables<-c("ageInYears", "sex01", "nbackRelMeanRMSMotion", "nbackBehAllDprime") 
lin.mod<-"~  ageInYears + sex01 + nbackRelMeanRMSMotion +nbackBehAllDprime"
###
...
#######################
file.copy("/data/jux/BBL/projects/exec_extern_sex/scripts/group_analysis_ageInYears_sex01_nbackRelMeanRMSMotion_nbackBehAllDprime_20180828.R",resultsdir)
