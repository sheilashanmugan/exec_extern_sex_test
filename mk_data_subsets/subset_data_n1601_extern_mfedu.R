...
data15<- subset(data14, medu1 != "NA") #n=1138
data16<- subset(data15, fedu1 != "NA") #n=1051
...
write.csv(data16, file = "/data/jux/BBL/projects/exec_extern_sex/inputData/data_agg/nback_n1051_from1601_20180831.csv")
