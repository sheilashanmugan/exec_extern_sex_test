...
data18sub <- subset(data18, select=c("bblid", "scanid", "sex1m1", "fedu1","medu1", "ageInYears", "nbackRelMeanRMSMotion", "nbackBehAllDprime", "cope.path.2m0", "varcope.path.2m0"))
...
saveRDS(mdata, file = "/data/jux/BBL/projects/exec_extern_sex/inputData/data_agg/nback_n939_from1601_oldImgPaths_pedumelt_20180905.rds")
