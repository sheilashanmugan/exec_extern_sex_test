...
###ALL COVARIATES
variables<-c("ageInYears_demean", "sex1m1_demean", "nbackRelMeanRMSMotion_demean") 
lin.mod<-"~  ageInYears_demean*sex1m1_demean + ageInYears_demean + sex1m1_demean + nbackRelMeanRMSMotion_demean" 
int <- "ageInYears_demeanXsex1m1_demean"
###
...
#######################
file.copy("/data/jux/BBL/projects/exec_extern_sex/scripts/group_analysis/group_analysis_ageXsex_ageInYearsDemean_sex1m1Demean_nbackRelMeanRMSMotionDemean_20180829.R",resultsdir)
