...
###ALL COVARIATES
variables<-c("ageInYears", "externalizing_4factorv2", "nbackRelMeanRMSMotion") 
lin.mod<-"~  ageInYears + externalizing_4factorv2 + nbackRelMeanRMSMotion"
###
...
#######################
file.copy("/data/jux/BBL/projects/exec_extern_sex/scripts/group_analysis/group_analysis_ageInYears_extern_nbackRelMeanRMSMotion_20180828.R",resultsdir)
