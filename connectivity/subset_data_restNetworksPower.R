...
data_nbackqa <-read.csv("/data/joy/BBL/studies/pnc/n1601_dataFreeze/neuroimaging/rest/n1601_RestQAData_20170714.csv", header = TRUE) #n1601
...
data_conn <-read.csv("/data/jux/BBL/projects/exec_extern_sex/inputData/connectivity/restNetworks_264PowerPNC/restNetworks_264PowerPNC_bet_within_connectivity.csv", header = TRUE) #n2267
...
#3) Modality-specific exclusions: 
data12 <- subset(data11, restExclude == 0) #n1200
...
write.csv(data16, file = "/data/jux/BBL/projects/exec_extern_sex/inputData/data_agg/restNetworks_264PowerPNC_dataagg_20180913.csv")
