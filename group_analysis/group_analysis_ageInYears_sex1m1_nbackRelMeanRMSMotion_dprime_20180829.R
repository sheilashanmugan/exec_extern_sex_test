...
###ALL COVARIATES
variables<-c("ageInYears", "sex1m1", "nbackRelMeanRMSMotion", "nbackBehAllDprime") 
lin.mod<-"~  ageInYears + sex1m1 + nbackRelMeanRMSMotion + nbackBehAllDprime"
###
...
#######################
file.copy("/data/jux/BBL/projects/exec_extern_sex/scripts/group_analysis/group_analysis_ageInYears_sex1m1_nbackRelMeanRMSMotion_dprime_20180829.R",resultsdir)
